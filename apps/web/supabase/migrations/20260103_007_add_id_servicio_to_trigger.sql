-- =====================================================
-- MIGRACIÓN: Agregar id_servicio al trigger generar_traslados_recurrente
-- Descripción: El trigger debe propagar TANTO id_servicio como id_servicio_recurrente
-- Fecha: 2026-01-03
-- Problema: Los traslados se crean con id_servicio NULL
-- Solución: Agregar NEW.id_servicio en los INSERT de traslados
-- =====================================================
...
BEGIN
  ...
  WHILE v_fecha_actual <= v_fecha_fin_efectiva LOOP
    ...
    IF v_debe_generar THEN
      ...
      -- ✅ Incluye AMBOS: id_servicio e id_servicio_recurrente
      INSERT INTO traslados (
        id_servicio, id_servicio_recurrente, id_paciente, id_motivo_traslado,
        ...
        NEW.id_servicio, NEW.id, NEW.id_paciente, NEW.id_motivo_traslado,
...
INCLUYE id_servicio (nivel 1) e id_servicio_recurrente (nivel 2) para mantener la jerarquía completa.
