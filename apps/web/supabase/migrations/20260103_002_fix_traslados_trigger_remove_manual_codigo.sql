-- =====================================================
-- MIGRACIÓN: Fix generación de códigos en trigger generar_traslados_recurrente
-- Descripción: Eliminar generación manual de códigos, dejar que BEFORE INSERT lo haga
-- Fecha: 2026-01-03
-- Problema: El trigger generar_traslados_recurrente generaba códigos manualmente,
--           compitiendo con trigger_generar_codigo_traslado, causando duplicados
-- Solución: Eliminar campo 'codigo' de los INSERT, dejar que trigger BEFORE INSERT
--           genere códigos únicos con UUID automáticamente
-- =====================================================
  ...
  WHILE v_fecha_actual <= v_fecha_fin_efectiva LOOP
    ...
    IF v_debe_generar THEN
      ...
      INSERT INTO traslados (
        id_servicio_recurrente, id_paciente,
