-- =====================================================
-- MIGRACIÓN: Actualizar generar_traslados_periodo para incluir id_motivo_traslado y ubicaciones
-- Problema: La función generar_traslados_periodo no incluye id_motivo_traslado ni ubicaciones
-- Solución: Actualizar INSERT para propagar todos los campos necesarios desde servicios
-- Fecha: 2026-01-03
-- =====================================================
      ...
      WHILE v_fecha_actual <= v_fecha_fin_efectiva LOOP
        ...
        IF v_debe_generar THEN
          ...
          VALUES (
            ...
            v_servicio.id_motivo_traslado,  -- ✅ Propagar desde servicios
            'ida',
            v_fecha_actual,
            v_servicio.hora_recogida,
            v_servicio.tipo_origen,         -- ✅ Propagar ubicaciones
            v_servicio.origen,
          ...
          IF v_servicio.requiere_vuelta = true THEN
            ...
            VALUES (
              v_servicio.id,
              v_servicio.id_paciente,
              v_servicio.id_motivo_traslado,  -- ✅ Propagar
              'vuelta',
              v_fecha_actual,
              v_servicio.hora_vuelta,
              v_servicio.tipo_destino,        -- ✅ Origen = Destino de IDA
              v_servicio.destino,
              v_servicio.tipo_origen,         -- ✅ Destino = Origen de IDA
              v_servicio.origen,
              v_servicio.destino_ubicacion_centro,
              v_servicio.origen_ubicacion_centro,
              v_servicio.tipo_ambulancia,
...
Propaga id_motivo_traslado, tipo_origen, origen, tipo_destino, destino desde servicios a traslados.
