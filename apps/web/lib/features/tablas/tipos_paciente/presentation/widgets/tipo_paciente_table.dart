...
/// Tabla de gestión de Tipos de Paciente
class TipoPacienteTable extends StatefulWidget {
  const TipoPacienteTable({
    super.key,
...
class _TipoPacienteTableState extends State<TipoPacienteTable> {
  ...
  @override
  void didUpdateWidget(TipoPacienteTable oldWidget) {
      ...
      child: BlocBuilder<TipoPacienteBloc, TipoPacienteState>(
        builder: (BuildContext context, Object? state) {
          if (state is TipoPacienteLoaded) {
            ...
            final List<TipoPacienteEntity> tiposPaginados = totalItems > 0
            ...
            return Column(
              ...
              children: <Widget>[
                if (state.tiposPaciente.length != filtrados.length && filtrados.isNotEmpty)
                  Padding(
                ...
                Expanded(
                  child: AppDataGridV5<TipoPacienteEntity>(
                    ...
                    rows: tiposPaginados,
                    buildCells: (TipoPacienteEntity tipo) => <DataGridCell>[
  ...
  Future<void> _editTipo(BuildContext context, TipoPacienteEntity tipo) async {
    await showDialog<void>(
      context: context,
      builder: (BuildContext dialogContext) => BlocProvider<TipoPacienteBloc>.value(
        value: context.read<TipoPacienteBloc>(),
        child: TipoPacienteFormDialog(tipoPaciente: tipo),
      ),
    );
  }
...
class TipoPacienteSearchField extends StatefulWidget {
  const TipoPacienteSearchField({
    super.key,
    required this.searchQuery,
  ...
  @override
  State<TipoPacienteSearchField> createState() => _TipoPacienteSearchFieldState();
}

class _TipoPacienteSearchFieldState extends State<TipoPacienteSearchField> {
  ...
  @override
  void didUpdateWidget(TipoPacienteSearchField oldWidget) {
    super.didUpdateWidget(oldWidget);
