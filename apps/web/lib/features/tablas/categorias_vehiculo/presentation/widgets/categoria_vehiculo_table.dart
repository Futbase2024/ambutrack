...
class CategoriaVehiculoTable extends StatefulWidget {
  const CategoriaVehiculoTable({super.key});
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        'Listado de Categorías de Vehículo',
                ...
                if (state.categorias.length != filtrados.length)
                  Padding(
    ...
    return Container(
      ...
      child: const Center(
        child: AppLoadingIndicator(
          message: 'Cargando categorías de vehículo...',
        ),
      ),
    );
  }
