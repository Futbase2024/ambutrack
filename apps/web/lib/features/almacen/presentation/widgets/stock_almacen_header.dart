...
/// Header de la página de stock de almacén con estadísticas integradas
class StockAlmacenHeader extends StatelessWidget {
  const StockAlmacenHeader({super.key});
      ...
      children: <Widget>[
        ...
        Column(
          ...
          children: <Widget>[
            ...
            Text(
              'Control centralizado de inventario con valoración FIFO',
              style: GoogleFonts.inter(
