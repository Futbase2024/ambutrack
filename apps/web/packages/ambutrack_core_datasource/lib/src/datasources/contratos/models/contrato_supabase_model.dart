...
part 'contrato_supabase_model.g.dart';

/// Modelo de datos Supabase para serialización de contratos
@JsonSerializable(fieldRename: FieldRename.snake, explicitToJson: true)
class ContratoSupabaseModel {

  const ContratoSupabaseModel({
    required this.id,
  ...
  factory ContratoSupabaseModel.fromEntity(ContratoEntity entity) {
    return ContratoSupabaseModel(
      id: entity.id,
  ...
  factory ContratoSupabaseModel.fromJson(Map<String, dynamic> json) =>
      _$ContratoSupabaseModelFromJson(json);
  final String id;
  final String codigo;
  ...
  Map<String, dynamic> toJson() => _$ContratoSupabaseModelToJson(this);
}
