...
/// Diálogo profesional que muestra la ubicación del fichaje en un mapa
///
/// Características:
...
/// - Botón de cierre
class UbicacionFichajeDialog extends StatelessWidget {
  const UbicacionFichajeDialog({
  ...
  Widget build(BuildContext context) {
    ...
    final latLng = LatLng(registro.latitud!, registro.longitud!);
    final precision = registro.precisionGps ?? 50.0;
                ...
                child: FlutterMap(
                  ...
                  children: [
                    ...
                    TileLayer(
                      ...
                      userAgentPackageName: 'com.ambutrack.ambutrack_mobile',
                      maxZoom: 19,
