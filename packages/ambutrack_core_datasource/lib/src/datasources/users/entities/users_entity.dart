...
class UserEntity extends BaseEntity {
  ...
  /// Alias para id (compatibilidad con UserEntity de auth)
  String get uid => id;

  /// Alias para isEmailVerified (compatibilidad)
  bool get emailVerified => isEmailVerified;

  /// Alias para isActive (compatibilidad con UserEntity de auth)
  bool? get activo => isActive;

  /// Primer rol del usuario (compatibilidad con UserEntity de auth que usa String?)
  /// Devuelve el primer rol de la lista o null si no hay roles
  String? get rol => roles.isNotEmpty ? roles.first : null;
